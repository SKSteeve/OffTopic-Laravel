                        ...
                        @foreach($allNotifications as $notification)
                            <li class="list-group-item clearfix d-flex align-items-center">
                                ...
                                <div class="buttons ml-auto">
                                    ...
                                    @else
                                        <button data-section="all" data-notification-id="{{ $notification->id }}" style="outline: none" class="close-notification close float-right @if(!empty($notification->deleted_at)) text-danger @endif" aria-label="Close">&times;</button>
                                    @endif
                                </div>
                            </li>
                        @endforeach
                        ...
                        @foreach($notDeletedNotifications as $notification)
                            <li class="list-group-item clearfix d-flex align-items-center">
                                ...
                                <div class="buttons ml-auto">
                                    ...
                                    @else
                                        <button data-section="not-deleted" data-notification-id="{{ $notification->id }}" style="outline: none" class="close-notification close float-right" aria-label="Close">&times;</button>
                                    @endif
                                </div>
                            </li>
                        @endforeach
                    ...
                    <ul class="notification-list list-group list-group-flush">
                        @foreach($deletedNotifications as $notification)
                            <li class="list-group-item clearfix d-flex align-items-center">
                                ...
                                <div class="buttons ml-auto">
                                    <button data-section="deleted" data-notification-id="{{ $notification->id }}" style="outline: none" class="close-notification close float-right text-danger" aria-label="Close">&times;</button>
                                </div>
                            </li>
                        @endforeach
                    </ul>
